...
RSpec.describe EveryDayJob, type: :job do
  ...
  it 'enqueues a job with Sidekiq' do
    Sidekiq::Testing.fake! do
      expect { EveryDayJob.perform_later }.to have_enqueued_job(described_class).on_queue('default')
    end
  end
end
